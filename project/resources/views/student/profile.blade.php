...
@section('content')
    ...
    <div class="container bootstrap snippet">
        <div class="row">
            <div class="ml-lg-5"><h1>Role: {{ Auth::user()->username }}</h1></div>
        </div>
        <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        ...
                        <form class="form" action="#" method="post" id="registrationForm">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name"
                                           value="{{ Auth::user()->username }}" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name"
                                           placeholder="Hidden" title="enter your first name if any.">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="email"><h4>Job Title</h4></label>
